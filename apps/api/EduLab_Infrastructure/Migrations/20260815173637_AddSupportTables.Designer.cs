...
namespace EduLab_Infrastructure.Migrations
{
    ...
    [Migration("20260815173637_AddSupportTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLab_Domain.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.Category", b =>
                {
                    ...
                    b.Property<string>("Category_EnglishName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.CourseCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.OperationKey", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.RefundRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ResolvedActions")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ReporterId", "Type", "TargetId")
                        .IsUnique();
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.SiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.SupportConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.History", b =>
                {
                    b.HasOne("EduLab_Domain.Entities.OperationKey", "OperationKey")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.RefundRequest", b =>
                {
                    b.HasOne("EduLab_Domain.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.Report", b =>
                {
                    b.HasOne("EduLab_Domain.Entities.ApplicationUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLab_Domain.Entities.SupportMessage", b =>
                {
                    b.HasOne("EduLab_Domain.Entities.SupportConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("EduLab_Domain.ApplicationRole", null)
                        .WithMany()
