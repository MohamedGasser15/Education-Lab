...
<head>
    ...
    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
    <title>EduLab - {_localizer["EmailReportWarnHeader"]}</title>
    <link href='{googleFontLink}' rel='stylesheet'>
    <style type='text/css'>
        body, table, td, a {{ font-family: {fontStack} !important; }}
        @@media only screen and (max-width:600px) {{
        ...
        <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0' class='email-container' style='max-width:560px;margin:0 auto;background-color:#ffffff;border-radius:16px;overflow:hidden;border-collapse:separate;box-shadow:0 10px 30px rgba(0,0,0,0.05);'>
                ...
                <td dir='{dir}' align='{align}' style='padding:28px 32px 20px;border-bottom:1px solid #f0f2f5;' class='resp-pad'>
                    <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0'>
                        <tr>
                            ...
                            <td align='{oppDir}' dir='{oppDir}' style='vertical-align:middle;'>
                                <span style='background-color:#fffbeb;color:#92400e;font-size:11px;font-weight:600;padding:4px 12px;border-radius:20px;border:1px solid #fde68a;display:inline-block;'>{_localizer["EmailReportWarnHeader"]}</span>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td dir='{dir}' align='{align}' style='padding:28px 32px;' class='resp-pad'>
                    ...
                    <div dir='{dir}' style='font-size:20px;font-weight:700;color:#0a1628;margin-bottom:8px;text-align:{align};'>
                        {_localizer["EmailReportWarnTitle"]}
                    </div>

                    <div dir='{dir}' style='color:#6b7280;font-size:14px;line-height:1.6;margin-bottom:24px;padding-bottom:16px;border-bottom:2px dashed #f0f2f5;text-align:{align};'>
                        {_localizer["EmailReportWarnMsg"]}
                    </div>

                    <!-- Report Details -->
                    <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0' style='background-color:#fffbeb;border-radius:12px;margin-bottom:24px;'>
                        <tr>
                            <td dir='{dir}' style='padding:6px 16px;'>
                                <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0' style='border-bottom:1px solid #fde68a;'>
                                    <tr>
                                        <td align='{align}' dir='{dir}' style='padding:10px 0;color:#92400e;font-size:13px;'>{_localizer["EmailReportWarnReasonLabel"]}</td>
                                        <td align='{oppDir}' dir='{oppDir}' style='padding:10px 0;color:#78350f;font-size:13px;font-weight:600;'>{reasonLabel}</td>
                                    </tr>
                                </table>
                                <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td align='{align}' dir='{dir}' style='padding:10px 0;color:#92400e;font-size:13px;'>{_localizer["EmailReportWarnTargetLabel"]}</td>
                                        <td align='{oppDir}' dir='{oppDir}' style='padding:10px 0;color:#78350f;font-size:13px;font-weight:600;'>{targetSummary}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table role='presentation' dir='{dir}' width='100%' border='0' cellspacing='0' cellpadding='0' style='background-color:#eff6ff;border-radius:10px;margin-bottom:24px;border-{padSide}:4px solid #3b82f6;'>
                        <tr>
                            <td align='{align}' dir='{dir}' style='padding:14px 16px;font-size:13px;color:#1e40af;line-height:1.5;'>
                                <strong style='display:block;font-size:14px;font-weight:700;margin-bottom:2px;color:#1e3a8a;'>{_localizer["EmailNotes"]}</strong>
                                {_localizer["EmailReportWarnNote"]}
                            </td>
                        </tr>
                    </table>
