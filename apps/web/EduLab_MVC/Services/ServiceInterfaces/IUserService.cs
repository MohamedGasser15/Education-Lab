...
namespace EduLab_MVC.Services.ServiceInterfaces
{
    ...
    public interface IUserService
    {
        ...
        Task<(bool Success, string Message)> DeleteRangeUsersAsync(List<string> userIds);
        ...
        /// <returns>Tuple indicating success status and message</returns>
        Task<(bool Success, string Message)> LockUsersAsync(List<string> userIds, int minutes);

        /// <returns>Tuple indicating success status and message</returns>
        Task<(bool Success, string Message)> UnlockUsersAsync(List<string> userIds);
