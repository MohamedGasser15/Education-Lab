    ...
    public class InstructorApplicationService : IInstructorApplicationService
    {
            ...
            try
            {
                ...
                if (applications != null)
                {
                    foreach (var app in applications)
                    {
                        ...
                        {
                            app.CvUrl = _imageBaseUrl + app.CvUrl;
                        }
                    }
                }
        ...
        public async Task<InstructorApplicationResponseDto?> GetApplicationDetailsAsync(string id, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    application.CvUrl = _imageBaseUrl + application.CvUrl;
                }
            ...
            try
            {
                ...
                if (applications != null)
                {
                    foreach (var app in applications)
                    {
                        ...
                        {
                            app.ProfileImageUrl = _imageBaseUrl + app.ProfileImageUrl;
                        }
        ...
        public async Task<AdminInstructorApplicationDto?> GetApplicationDetailsAdminAsync(string id, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                if (application != null)
                {
                    ...
                    {
                        application.ProfileImageUrl = _imageBaseUrl + application.ProfileImageUrl;
                    }
