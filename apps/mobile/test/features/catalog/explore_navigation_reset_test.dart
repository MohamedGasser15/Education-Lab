...
void main() {
  testWidgets('Tapping Explore navigation bar icon while in search results resets to root Explore screen', (tester) async {
    ...
    await tester.pumpWidget(
      MultiProvider(
        providers: [
          ChangeNotifierProvider<ExploreProvider>.value(value: exploreProvider),
          ChangeNotifierProvider<CartProvider>.value(value: cartProvider),
          ChangeNotifierProvider<EnrollmentProvider>.value(value: enrollmentProvider),
