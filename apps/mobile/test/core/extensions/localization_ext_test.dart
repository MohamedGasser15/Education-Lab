...
void main() {
  group('LocalizationExt', () {
    ...
    testWidgets(
      'instructor profile localization keys are present and accurate in Arabic',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            locale: const Locale('ar'),
            ...
            home: Builder(
              builder: (context) {
                ...
                expect(
                  context.loc.instructorProfileTotalStudents,
                  'إجمالي الطلاب',
                );
                ...
                expect(
                  context.loc.instructorProfileLinkCopied('محمد'),
                  'تم نسخ رابط ملف محمد',
                );
                return const SizedBox();
              },
            ),
    ...
    testWidgets(
      'instructor profile localization keys are present and accurate in English',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            ...
            home: Builder(
              builder: (context) {
                ...
                expect(
                  context.loc.instructorProfileLinkCopied('John'),
                  'Link for John copied to clipboard',
                );
                return const SizedBox();
              },
            ),
