...
class _LearningScreenState extends State<LearningScreen> {
  ...
  List<EnrollmentModel> _processCourses(List<EnrollmentModel> allCourses) {
    ...
    switch (_statusFilter) {
      ...
      case CourseStatusFilter.completed:
        list = list
            .where((c) => c.isCompleted || c.progressPercentage >= 100)
            .toList();
        break;
    ...
    switch (_sortOption) {
      case CourseSortOption.recentEnrolled:
        list.sort(
          (a, b) => (b.enrolledAt ?? b.createdAt ?? DateTime(2000)).compareTo(
            a.enrolledAt ?? a.createdAt ?? DateTime(2000),
          ),
        );
        break;
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _buildModalChoiceChip(
                        ...
                        onSelected: () => setModalState(
                          () => tempSort = CourseSortOption.recentEnrolled,
                        ),
                        isDark: isDark,
                      ),
                      _buildModalChoiceChip(
                        ...
                        onSelected: () => setModalState(
                          () => tempSort = CourseSortOption.titleAZ,
                        ),
                        isDark: isDark,
                      ),
                      _buildModalChoiceChip(
                        ...
                        onSelected: () => setModalState(
                          () => tempSort = CourseSortOption.progressHigh,
                        ),
                        isDark: isDark,
                      ),
                    ],
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _buildModalChoiceChip(
                        ...
                        onSelected: () => setModalState(
                          () => tempStatus = CourseStatusFilter.inProgress,
                        ),
                        isDark: isDark,
                      ),
                      _buildModalChoiceChip(
                        ...
                        onSelected: () => setModalState(
                          () => tempStatus = CourseStatusFilter.completed,
                        ),
                        isDark: isDark,
                      ),
                      _buildModalChoiceChip(
  ...
  Widget build(BuildContext context) {
    ...
    final inProgressCourses = allCourses
        ...
        .toList();
    final heroCourse = inProgressCourses.isNotEmpty
              ...
              children: [
                Expanded(
                  child: _buildSectionTabPill(
                    ...
                    isSelected:
                        _currentSection == LearningMainSection.myCourses,
  ...
  Widget _buildMyCoursesView({
    ...
    if (allCourses.isEmpty) {
      return RefreshIndicator(
        color: AppColors.primary,
        onRefresh: () =>
            enrollmentProvider.fetchEnrollments(forceRefresh: true),
        child: _buildEmptyState(
          icon: Icons.school_rounded,
          iconColor: AppColors.primary,
          glowColor: AppColors.primary,
          floatingBadgeTop: const Icon(
            Icons.star_rounded,
            size: 14,
            color: Color(0xFFD97706),
          ),
          floatingBadgeBottom: const Icon(
          ...
          secondaryAction: cartCount > 0
              ...
              : _buildSubtleCartLink(textSubColor: textSubColor, isAr: isAr),
        ),
      );
    }
                      ...
                      child: Row(
                        children: [
                          _buildQuickFilterPill(
                            title: context.loc.learningFilterAllCount(
                          ...
                          _buildQuickFilterPill(
                            ...
                            isSelected:
                                _statusFilter == CourseStatusFilter.inProgress,
                            onTap: () => setState(
                              () =>
                                  _statusFilter = CourseStatusFilter.inProgress,
                            ),
                          ...
                          _buildQuickFilterPill(
                            ...
                            isSelected:
                                _statusFilter == CourseStatusFilter.completed,
                            onTap: () => setState(
                              () =>
                                  _statusFilter = CourseStatusFilter.completed,
                            ),
                          ...
                          _buildQuickFilterPill(
                            ...
                            isSelected:
                                _statusFilter == CourseStatusFilter.notStarted,
                            onTap: () => setState(
                              () =>
                                  _statusFilter = CourseStatusFilter.notStarted,
                            ),
              ...
              sliver: SliverList.separated(
                ...
                itemBuilder: (context, index) {
                  if (_searchQuery.isEmpty &&
                      ...
                      heroCourse != null) {
                    if (index == 0) {
                      return _buildContinueWatchingHero(
                        heroCourse,
                        cardBg,
                        borderColor,
                        textColor,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Center(child: Icon(icon, size: 38, color: accentColor)),
            ),
            const SizedBox(height: 18),
            Text(
              title,
            ...
            AppButton(
              text: context.loc.learningViewAllCoursesCount(
                allCourses.length.toString(),
              ),
              width: null,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            context.loc.learningSavedCoursesCount(
    ...
    return RefreshIndicator(
      ...
      child: certificates.isEmpty
          ? _buildEmptyState(
              ...
              primaryButtonIcon: allCourses.isNotEmpty
  ...
  Widget _buildSubtleCartLink({
    ...
    return TextButton.icon(
      ...
      icon: Icon(Icons.shopping_cart_outlined, size: 16, color: textSubColor),
      label: Text(
