...
class HomeCourseDTO {
  ...
  const HomeCourseDTO({
    ...
    this.gradient = const [AppColors.primary, AppColors.roleInstructor],
    this.createdAt,
  });
  ...
  factory HomeCourseDTO.fromJson(Map<String, dynamic> json) {
    ...
    final bool isBest =
        json['isBestseller'] == true || (rating >= 4.7 && reviewsCount > 30);
    ...
    final String duration = _formatCourseDuration(
      rawDuration,
    ...
    final List<List<Color>> paletteGradients = [
      [AppColors.primary, AppColors.roleInstructor],
      [AppColors.textPrimary, AppColors.darkDivider],
      [AppColors.primaryDark, AppColors.primary],
      [AppColors.successDark, AppColors.emerald],
      [AppColors.sky, AppColors.accent],
    ...
    final Color badgeBg = isFeatured
        ...
        : (isBest ? AppColors.warningLight : AppColors.successLight);
    final Color badgeTextCol = isFeatured
        ? AppColors.primary
        : (isBest ? AppColors.warningDark : AppColors.successDark);
  ...
  String getLocalizedDuration(BuildContext context) {
    ...
    if (duration != null && duration!.isNotEmpty) {
      return AppDateUtils.localizeDurationString(
        duration!,
...
class HomeCategoryDTO {
  ...
  String getLocalizedName(BuildContext context) {
    if (context.isArabic) {
      return nameAr.isNotEmpty
          ? nameAr
          : (nameEn.isNotEmpty ? nameEn : context.loc.categoryWord);
    } else {
      return nameEn.isNotEmpty
          ? nameEn
          : (nameAr.isNotEmpty ? nameAr : context.loc.categoryWord);
    }
  }
