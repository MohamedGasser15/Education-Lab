class ApiConstants {
  ...
  static const String profile = "learner/profile";
  static const String myCourses = "learner/courses";
  static const String notifications = "learner/notifications";
  static const String cart = "learner/cart";
  static const String wishlist = "learner/wishlist";

  static const String settings = "site-settings";
